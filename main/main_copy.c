...
static void write_to_ggsheet()
{
    esp_http_client_config_t generate_config = {
        .url = "https://script.google.com/macros/s/AKfycbyzL7zA6wl24y_g2p6yJQwwU84tWOZ7TboWcdESxGXJfqWPSWYGxMDNTj-5N953zjuClg/exec",
    ...
    int written = snprintf(json_payload, sizeof(json_payload),
                           "{\"name\": \"%s\", \"contents\": \"%s\"}", name, content);
