...
char text1[] = "Đại học Bách Khoa Hà Nội được thành lập năm 1956, là một trong những trường đại học hàng đầu tại Việt Nam. Trường có nhiều chuyên ngành đào tạo và nghiên cứu khoa học đa dạng, từ kỹ thuật đến khoa học xã hội. Đại học Bách Khoa Hà Nội cũng nổi tiếng với các chương trình hợp tác quốc tế và các dự án nghiên cứu ứng dụng thực tiễn.";
static void upload()
{
    esp_http_client_config_t generate_config = {
      .url = "https://script.google.com/macros/s/AKfycbwYb9098qfQezhyBl2DIID93BKeQAgGMMK7AdPO359fsAwZ4tsY8kT6nGQn-2nIFjaCow/exec",
  ...
  int written = snprintf(json_payload, sizeof(json_payload), "{\"distance\": \"%s\"}", text1);
  ...
  {
    printf("GenerateContent request successful\n");
  }
...
void app_main(void)
{
  ...
  // i2sInit();
  // xTaskCreate(i2s_adc, "i2s_adc", 2048 * 25, NULL, 10, NULL);
